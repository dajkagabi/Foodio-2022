...
function Shop_LPizza() {
  ...
  useEffect(() => {
    Axios.get("http://localhost:3001/kategoriatermekek/lpizza")
  ...
  return (
    <CartProvider>
      <Header />
      <div className="text-center mt-3 h1">Laktózmentes Pizzák</div>
