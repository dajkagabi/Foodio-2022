...
function Shop_Hamburger() {
  ...
  useEffect(() => {
    Axios.get("http://localhost:3001/kategoriatermekek/hamburger")
  ...
  return (
    <CartProvider>
      <Header />
      <div className="text-center mt-3 h1">Hamburgerek</div>
