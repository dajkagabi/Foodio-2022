...
function Shop_TPizza() {
  ...
  useEffect(() => {
    Axios.get("http://localhost:3001/kategoriatermekek/tpizza")
  ...
  return (
    <CartProvider>
      <Header />
      <div className="text-center mt-3 h1">Töltött Peremű Pizza</div>
